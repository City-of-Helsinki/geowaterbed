...
(function() {
  var blue_icon, center_marker, create_map, makeMap, red_icon, update_markers;
  ...
  create_map = function() {
    ...
    makeMark = function(data) {
      ...
      markers[data.title] = L.marker([data.x, data.y], {
        'title': data.title,
        riseOnHover: true,
        icon: data.selected ? red_icon : blue_icon
      }).addTo(map);
    ...
    makeMarks = function() {
      var id, obs, ref, results, selected;
  ...
  update_markers = function(marker_id) {
    var key, marker, markers;
    markers = window.markers;
    for (key in markers) {
      marker = markers[key];
      marker.setIcon(blue_icon);
    }
    return markers[marker_id].setIcon(red_icon);
  };

  center_marker = function(marker_id) {
    var cM, marker;
